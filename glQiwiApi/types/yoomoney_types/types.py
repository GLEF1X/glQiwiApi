...
class OperationDetails:
    ...
    recipient_type: Optional[Literal['account.rst', 'phone', 'email']] = None
    """
    Тип идентификатора получателя перевода. Возможные значения:
    account.rst — номер счета получателя в сервисе ЮMoney;
...
class Payment:
    ...
    - токен авторизации обладает правом account.rst-info.
    """
