...
# If ext (or modules to document with autodoc) are in another directory,
...
# ext coming with Sphinx (named 'sphinx.ext.*') or your custom
# ones.
extensions = [
    "sphinx.ext.todo",
    "sphinx.ext.viewcode",
...
parsed_version = parse_version(glQiwiApi.__version__)
...
man_pages = [(master_doc, "glQiwiApi", "glQiwiApi Documentation", [author], 1)]
