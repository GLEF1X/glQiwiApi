...
from glQiwiApi.core.event_fetching.webhooks.config import WebhookConfig, EncryptionConfig, \
...
app = web.Application()
configure_app(dp, configure_app_for_qiwi_webhooks(wallet, qiwi_dp, app, WebhookConfig(
    ...
    ), hook_registration=HookRegistrationConfig(
        host_or_ip_address="айпи:8080"
    )
)), "/bot")
